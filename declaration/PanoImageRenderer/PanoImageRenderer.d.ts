...
declare class PanoImageRenderer extends Component<{
    ...
    private _animator;
    private _vr;
    constructor(image: ImageCandidate | VideoCandidate, width: number, height: number, isVideo: boolean, sphericalConfig: PanoImageRenderer["sphericalConfig"], renderingContextAttributes?: WebGLContextAttributes);
